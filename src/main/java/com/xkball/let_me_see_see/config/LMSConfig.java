...
public class LMSConfig {
    ...
    public static final ModConfigSpec.ConfigValue<String> IDEA_PATH_CONFIG = BUILDER
            .comment("The path of your Intellij IDEA (idea64.exe) (Or other program can open .class file)")
            .define("idea_path", "");
    public static final ModConfigSpec.ConfigValue<List<? extends String>> EXPORT_LANG_CONFIG = BUILDER
            .comment("Languages use on item name when item data export.")
            .defineList("languages", List.of("en_us", "zh_cn"), null, o -> o instanceof String);
